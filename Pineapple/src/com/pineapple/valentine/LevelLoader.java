...
public class LevelLoader {
	...
	public LevelLoader(int level){
		...
		case 5://Go downhill			
			...
			//Ground
			ground = new int[][]{
					{-100, 10, 20, 400, 490, 580, 760, 800, 820, 821, 880, 931, 1000, 1200, 1400, 2000, 2600, 3000, 3100, 3200, 3300, 4000, 4600},
					{50, 60, 100, 10,  150,  285, 550, 600, 615, 650, 740, 780, 930,  1230, 1500, 1400, 1300, 1200, 1150, 1100, 1100, 2000, 2000}
			};
		...
		case 9: //How a Maze (ing)
			...
			//Hints
			hints.add(new Hint(50, 0, "Oh a butterfly! I love butterflies! There's one more. And there! Over there, on the flower! What a nice flower, I can count to SIX of them. Maybe I'll take one with me when I go back home. Oh well, I should start climbing.. //A happy Papilian"));
			hints.add(new Hint(2000, 0, "Aah!! I did climb all of them... and counted to nine! NINE!! My legs are killing me! //A tired Papilian"));
			break;
		case 10:
			//Start and finish
			startPos = new int[]{10, 0};
		...
		case 11: //Final boss fight
			...
			p2 = new int[][]{//Roof
					{1280, 2200},
					{-300, -600},
					{1280, 1500, 2000, 2199, 2200},
					{-300, -30, -330, -435, -600}
			};
			
			p3 = new int[][]{//Mentor haven
					{200, 220, 1280, 1300},
					{-75, -75, -75, -75},
			...
			//Birds
			birds.add(new Bird(2320, -420 - 43, false));
			//Antagonist
			break;
		case 12: //Credits
			...
			hints.add(new Hint(560, 208, "Idea and programming:*Joar Lind*Oskar Waglund"));
			hints.add(new Hint(635, 208, "Art director:*Joar Lind"));
			hints.add(new Hint(690, 182, "Audio engineer:*Oskar Waglund"));
			hints.add(new Hint(800, 146, "Composer:*Joar Lind"));

			hints.add(new Hint(1070, 208, "Thanks to Martin, Sven-Erik and Henrik for your work! And thank you beta squad for testing!"));
			hints.add(new Hint(1110, 208, "A big thank you to ScoreLoop for their service!"));
			hints.add(new Hint(1190, 208, "Additional sound effects provided by SoundBible.com."));
